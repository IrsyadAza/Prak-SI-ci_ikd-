                ...
                <tbody align="center">
                    ...
                    ?>
                                                    <tr>
                                                        ...
                                                        <td><?= round($row->C1 / $roww->maxminK1, 2) ?> X <?= $x->nilai_kriteria ?> =
                                                            <?= round(($row->C1 / $roww->maxminK1) * $x->nilai_kriteria, 3) ?></td>
                                                        <td><?= round($row->C2 / $roww->maxminK2, 2) ?> X <?= $y->nilai_kriteria ?> =
                                                            <?= round(($row->C2 / $roww->maxminK2) * $y->nilai_kriteria, 3) ?></td>
                                                        <td><?= round($row->C3 / $roww->maxminK3, 2) ?> X <?= $y->nilai_kriteria ?> =
                                                            <?= round(($row->C3 / $roww->maxminK3) * $y->nilai_kriteria, 3) ?></td>
                                                        <td><?= round($row->C4 / $roww->maxminK4, 2) ?> X <?= $y->nilai_kriteria ?> =
                                                            <?= round(($row->C4 / $roww->maxminK4) * $y->nilai_kriteria, 3) ?></td>
                                                        <td><?= round($row->C5 / $roww->maxminK5, 2) ?> X <?= $y->nilai_kriteria ?> =
                                                            <?= round(($row->C5 / $roww->maxminK5) * $y->nilai_kriteria, 3) ?></td>
                                                        <td><?= round($row->C6 / $roww->maxminK6, 2) ?> X <?= $y->nilai_kriteria ?> =
                                                            <?= round(($row->C6 / $roww->maxminK6) * $y->nilai_kriteria, 3) ?></td>
